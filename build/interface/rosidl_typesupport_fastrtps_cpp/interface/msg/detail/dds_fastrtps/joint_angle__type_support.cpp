...
#include "interface/msg/detail/joint_angle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface::msg::JointAngle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::msg::JointAngle & ros_message)
{
  // Member: joint1
  cdr >> ros_message.joint1;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
max_serialized_size_JointAngle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const interface::msg::JointAngle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface::msg::JointAngle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JointAngle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interface::msg::JointAngle *>(
...
static size_t _JointAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JointAngle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JointAngle__callbacks = {
  "interface::msg",
  "JointAngle",
...
static rosidl_message_type_support_t _JointAngle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JointAngle__callbacks,
...
get_message_type_support_handle<interface::msg::JointAngle>()
{
  return &interface::msg::typesupport_fastrtps_cpp::_JointAngle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, msg, JointAngle)() {
  return &interface::msg::typesupport_fastrtps_cpp::_JointAngle__handle;
}
