...
def generate_launch_description():
    package_name = 'robov2description'

    robot_name_in_model = 'ROBOv2'

    pkg_share = FindPackageShare(package=package_name).find(package_name) 
    urdf_model_path = os.path.join(pkg_share, f'config/gazebo_ROBOv2.urdf.xacro')
    ...
    node_robot_state_publisher = Node(
        ...
        parameters=[{'use_sim_time': True}, params, {"publish_frequency":10.0}],
        output='screen'
    )
